...
P_k_m = 1/(L+ASPKF.kappa)*(ASPKF.kappa*(Sigma_pts_k_m(1:6,1)-X_k_m(1:6))*(Sigma_pts_k_m(1:6,1)-X_k_m(1:6))');
for ii = 2:2*L+1
...
ASPKF.X_hat.omega_hat = u_b_gyr - bias_gyr; %ang vel is just gyro minus bias
