...
vP = propPQ*(Control.twist.angVel(1) - Twist.angVel(1)) + derivPQ*derivError(1);
vQ = propPQ*(Control.twist.angVel(2) - Twist.angVel(2)) + derivPQ*derivError(2);
vR = propR *(Control.twist.angVel(3) - Twist.angVel(3)) +  derivR*derivError(3);

Control.angVelPrev = Control.twist.angVel;
