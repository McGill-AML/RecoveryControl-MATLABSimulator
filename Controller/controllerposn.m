...
errAltitudePrev = Control.err.altitude;
errAltitudeDerivPrev = Control.err.altitudeDeriv;

errAttRollPrev = Control.err.euler(1);
errAttPitchPrev = Control.err.euler(2);
errAttYawPrev = Control.err.euler(3);
errAttYawDerivPrev = Control.err.yawDeriv;
...
Control.rpm = rpm;
Control.err.altitude = errAltitude;
Control.err.altitudeDeriv = errAltitudeDeriv;
Control.err.euler = [errAttRoll; errAttPitch; errAttYaw];
Control.err.yawDeriv = errAttYawDeriv;
