...
Est_sensPars = sensParams;
 ...
 Est_sensPars.var_acc = abs(sensParams.var_acc);% + randn(3,1)*0.1);

 Est_sensPars.var_gyr =  abs(sensParams.var_gyr);% + randn(3,1)*0.0003);

 Est_sensPars.var_mag =  abs(sensParams.var_mag);% + randn(3,1)*0.00003);
