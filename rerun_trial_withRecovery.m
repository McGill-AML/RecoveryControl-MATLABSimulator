...
%                     %+[ 2*abs(ImpactIdentification.wallNormalWorldCorrected2(2));0;0];   % provide recoil component in IC velocity Direction
        ...
        Trial = {offset, pitchImpact, ...
                 ...
                 sum(FirstNormalExpected)/norm(sum(FirstNormalExpected)),ActualAcc, ...
                 Plot.times, Plot.posns, Plot.defls, ...
                 Plot.recoveryStage, Hist.states,[Hist.controls.rpm]',...
                 [Hist.controls.u]', Plot.eulerAngles, Plot.normalForces, ...
