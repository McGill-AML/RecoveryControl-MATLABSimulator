...
%     display(size(ttotal))
    ...
    if recover*recover_control == 1
        ...
        [control,ez,evz,eroll,epitch,eyaw,er,omega,roll,pitch,yaw,roll_des,pitch_des,r_des,u1,u2,u3,u4] = ControllerICRA_crash6(Xtotal(end,:),i,t0,dt,z_des,traj_head,traj_att,ez_prev,evz_prev,eroll_prev,epitch_prev,eyaw_prev,er_prev,omega_prev,recover,off_control);
%         if i >= Tc_act
%             u1 = -m*g;
%         end
%         
