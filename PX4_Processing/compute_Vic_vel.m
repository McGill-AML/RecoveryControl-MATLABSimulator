...
%                 sim_w_exp_data;
                useExpData = 1;
                initExtData;
                [maxaccvals, maxaccinds] = max(IMU_AccX);
                vicDelay = 10;
                
               diff([VISN_X((maxaccinds-8:maxaccinds-3)+vicDelay), VISN_Y((maxaccinds-8:maxaccinds-3)+vicDelay), VISN_Z((maxaccinds-8:maxaccinds-3)+vicDelay)])
