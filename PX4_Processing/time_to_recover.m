...
% for non EKF set (set s), theres no file for s07 and s20, and s52, s54 and
% s56 dont enter recovery stage 1. So theres only 55 viable recoveries. fileNo = [1:6, 8:19, 21:60]

no_recovery(7) = 1;
no_recovery(20) = 1;
% for EKF sets (set a), theres no file for 46
% no_recovery(46) = 1;

for fileNo = [1:6, 8:19, 21:60]
...
mean(first_stage_1(~no_recovery))
