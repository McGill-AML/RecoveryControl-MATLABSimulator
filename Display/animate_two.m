function [ ] =animate( recordAnimation,Hist1,sideview,ImpactParams,timeImpact )
...
for iFrame = 1:4:size(t,1)
    ...
    %% Plot contact points
    for iBumper = 1:4
       pointContactWorld = Hist1.contacts(iFrame).point.contactWorld(:,iBumper);
