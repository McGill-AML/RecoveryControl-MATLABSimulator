                ...
                %waited enuff time to calculate
                    switch iInput 
                        ...
                        case 2 %FLP input 2: Inclination
                            ...
                            negBodyZ = [0;0;-1]; %[0;0;1] for NWU, %[0;0;-1] for NED
                            ...
                            dotProductWithWorldZ = dot(bodyZProjection,[0;0;-1]); %[0;0;1] for NWU, %[0;0;-1] for NED
                        ...
                        case 3 %FLP input 3: Flipping Direction Angle
                            ...
                            angVelWorldPerp = cross(angVelWorld,[0;0;-1]); %[0;0;1] for NWU, %[0;0;-1] for NED
